...
bool DeviceSetupWizard::showQuitMessage()
{
    auto question = QMessageBox::question(this, tr("Abord configurtion"),
      tr("Closing the wizzard will leave you with an unconfigured QUsb2snes. You can still activate support later from the system tray device menu but you will not be guided"));
    return question == QMessageBox::Ok;
}
